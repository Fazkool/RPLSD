                ...
                <div class='row'>
                  <div class='col-sm-6 col-sm-offset-3'>
                    <div class='text-center'>
                      ...
                      <small class='text-muted'>Masukkan testimoni untuk restoran kesayangan anda!</small>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class='col-sm-12'>
                  <div class='box'>
                    ...
                    <div class='box-content'>
                      <form class="form form-horizontal" style="margin-bottom: 0;" method="post" action="rate.php" accept-charset="UTF-8"><input name="authenticity_token" type="hidden" />
                      <input type="hidden" name="id" id="id" value="<?php echo $_GET["id"] ?>"></input>
                      <hr class="hr-normal">
                      <div class='form-group'>
                        <label class='col-md-2 control-label' for='alamat'>Testi</label>
                        <div class='col-md-5'>
                          <input class='form-control' id='testi' name="testi" type='text'>
                        </div>
                      </div>
                      <hr class="hr-normal">
                      <div class='form-group'>
                        <label class='col-md-2 control-label' for='telepon'>Rate</label>
                        <div class='col-md-5'>
                          <input class='form-control' id='rate' name="rate" type='number' min='0' max='10'>
                        </div>
                      </div>
